...
let iconUsed = ['faCoffee', 'faList', 'faUsers', 'faComments', 'faUserTie', 'faDotCircle', 'faPlus', 'faPrint', 'faDownload', 'faTrash', 'faTrashAlt', 'faSave', 'faCheck', 'faEdit',
  ...
  'faChartLine', 'faCalendarCheck', 'faCalendarAlt', 'faHourglassHalf', 'faCheckSquare', 'faLock', 'faCartPlus', 'faTimesCircle', 'faHeadset', 'faQuestionCircle', 'faTachometerAlt', 'faUserFriends', 'faCircleNotch', 'faTabletAlt'
]

<template>
  <ul class="list-group list-group-flush">
    <li class="list-group-item py-1 px-2"><fa icon="bookmark" /> Saved <span class="float-right">8</span></li>
    <li class="list-group-item py-1 px-2"><fa icon="address-book" /> Contacts <span class="float-right">23</span></li>
    ...
    <li class="list-group-item py-1 px-2"><fa icon="file" /> File <span class="float-right">1</span></li>
    <li class="list-group-item py-1 px-2"><fa icon="link" /> Links <span class="float-right">21</span></li>
  </ul>
</template>
<script>
export default{
